...
namespace SCR
{
    public class PlaceCSVDownloader
    {
        // CSV 다운로드용 URL
        private static string csvUrl = "https://docs.google.com/spreadsheets/d/1nFISX0ze0VBqKBGvco_3uJEvvr0sqsjsuMoA-5QZwsA/export?format=csv&gid=";

        // 파일 저장 경로 (유니티 에디터의 Assets 폴더 내)
        private static string savePath = "Assets/CSV/Mission/";
        private static string sheetsIDPath = "Assets/CSV/CSV SO Saver/CSVSaver/Place SheetsID.asset";
        private static SheetsID saveType;

#if UNITY_EDITOR
        [MenuItem("PangTastic/Download Place CSV")] // 메뉴 경로
        public static void StartDownloadPlaceCSVFile()
        {
