        ...
        public void InitBlockArray()
        {
            ...
            for (int x = 0; x < BlockPlate.BlockPlateWidth; x++)
            {
                for (int y = 0; y < BlockArray.GetLength(0); y++)
                {
                    ...
                    {
                        if (BlockPlate.BlockPlateArray[y, x] && BlockArray[y, x] == null) BlockArray[y, x] = new Block { GemType = (GemType)num };
                    }
                    else
                    {
                        BlockArray[y, x] = new Block { GemType = (GemType)num };
                    }
                }
            ...
            BlockArray[1, 5] = new Block { GemType = GemType.DonutBox };
