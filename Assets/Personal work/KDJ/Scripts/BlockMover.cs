...
namespace KDJ
{
    public class BlockMover : MonoBehaviour
    {
        ...
        public bool MoveBlock(BoardManager boardManager)
        {
            ...
            if (startGrid.x < 0 || startGrid.y < 0 || startGrid.x >= boardManager.Spawner.BlockPlate.BlockPlateWidth || startGrid.y >= boardManager.Spawner.BlockPlate.BlockPlateHeight)
            {
            ...
            if (boardManager.Spawner.BlockArray[startGrid.y, startGrid.x].GemType == GemType.Cloche || boardManager.Spawner.BlockArray[endGrid.y, endGrid.x].GemType == GemType.Cloche) return false;
