...
//        }
//        int testX = BlockPlate.BlockPlateWidth / 2;
//        int testY = BlockPlate.BlockPlateHeight / 2;

//        if (BlockPlate.BlockPlateArray[testY, testX] && BlockArray[testY, testX] != null)
//        {
//            BlockArray[testY, testX].BlockType = 12;
//            BlockArray[testY, testX].GemType = (SCR.GemType)12;
//        }
//        // 테스트 코드
...
//                            continue;
//                        }
//                        else if (BlockArray[y, x].BlockInstance == null)
//                        {
//                            // 시각적 오브젝트만 파괴된 상태라면 데이터도 정리
//                            BlockArray[y, x] = null;
//                        }
