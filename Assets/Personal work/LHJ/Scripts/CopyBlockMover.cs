...
//public class CopyBlockMover : MonoBehaviour
//{
...
//        var endGO = boardManager.Spawner.BlockArray[endGrid.y, endGrid.x].BlockInstance;
//        var startGO = boardManager.Spawner.BlockArray[startGrid.y, startGrid.x].BlockInstance;

//        var endSpecial = endGO != null ? endGO.GetComponent<LHJ.SpecialBlock>() : null;
//        var startSpecial = startGO != null ? startGO.GetComponent<LHJ.SpecialBlock>() : null;

//        if (endSpecial != null)
//        {
//            endSpecial.Activate(boardManager);
//        }
//        if (startSpecial != null)
//        {
//            startSpecial.Activate(boardManager);
//        }
//    }

//    public void ReturnBlock(BoardManager boardManager)
//    {
//        if (boardManager.Spawner.BlockArray[StartBlockPos.y, StartBlockPos.x] == null ||
//        boardManager.Spawner.BlockArray[EndBlockPos.y, EndBlockPos.x] == null)
//            return;
//        // 블록을 원래 위치로 되돌리는 로직
