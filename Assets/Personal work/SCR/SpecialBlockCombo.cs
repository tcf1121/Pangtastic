...
namespace SCR_B
{
    public class SpecialBlockCombo : MonoBehaviour
    {
        ...
        //     Vector2Int startPos = BlockMover.GetStartPos();
        //     Vector2Int endPos = BlockMover.GetEndPos();
        ...
        //             for (int x = 0; x < w; x++)
        //             {
        //                 var cell = spawner.BoardData.BlockArray[y, x];
        ...
        //     int destroyed = 0;
        //     var blk = b.BoardData.BlockArray;
        //     for (int x = 0; x < W; x++)
        //     {
        //         if (blk[y, x] != null)
